...
from callbacks import callback_default, callback_moons_rbf
...
#%%
class VAE_rbf_base(nn.Module):
    def __init__(self, lr):
        super(VAE_rbf_base, self).__init__()
        self.switch = 0.0
        self.lr = lr
...
class VAE_rbf_moons(VAE_rbf_base):
    def __init__(self, lr):
        super(VAE_rbf_moons, self).__init__(lr=lr)
